...
python -m verl.trainer.main_ppo \
    ...
    trainer.nnodes=1 \
    trainer.default_local_dir=targets/chart2code_mllm_remain-Qwen2-VL-7B-Instruct-Random-4k \
...
#    kill   $(ps aux | grep chart2code_mllm_remain-Qwen2-VL-7B-Instruct-Random-4k | grep -Ev 'grep --color=auto' | awk '{print $2}' | tr '\n' ' ')
#

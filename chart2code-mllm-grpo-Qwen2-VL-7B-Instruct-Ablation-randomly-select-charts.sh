...
MODEL_PATH=/data/MY_USERNAME/hf_dl/Qwen2-VL-7B-Instruct
...
python -m verl.trainer.main_ppo \
    ...
    data.train_files=/home/MY_USERNAME/dmc61-workspace/veRL-MLLM-GRPO/data-rl-parquet/chart2code_mllm-20251226_155324/chart2code_combo_3k_train.parquet \
    data.val_files=/home/MY_USERNAME/dmc61-workspace/veRL-MLLM-GRPO/data-rl-parquet/chart2code_mllm-20251226_155324/chart2code_combo_3k_train.parquet \
    ...
    trainer.nnodes=1 \
    trainer.default_local_dir=targets/chart2code_mllm_qwen2_vl_7b_instruct_ablation_randomly_select_charts \
    trainer.default_hdfs_dir=null \
    trainer.save_freq=47 \
    trainer.test_freq=-1 \
...
#
# 1. 快速后台启动
#    pyclean . && nohup bash chart2code-mllm-grpo-Qwen2-VL-7B-Instruct-Ablation-randomly-select-charts.sh > /dev/null 2>&1 & 
# 
# 2. 一键后台 kill (发送 SIGTERM)
#    kill   $(ps aux | grep chart2code_mllm_qwen2_vl_7b_instruct_ablation_randomly_select_charts | grep -Ev 'grep --color=auto' | awk '{print $2}' | tr '\n' ' ')
#
...
# ---- 消融实验构造随机数据集 chart_type 分布比例
# the original train dataset has:  48373
# randomly selected training dataset: 3008
# bar ---> 679
# scatter ---> 238
# line ---> 509
# treemap ---> 91
...
# histogram ---> 35
# density ---> 4
# None ---> 1          # 论文里面使用 None 不太好看，就写 mix 类型吧

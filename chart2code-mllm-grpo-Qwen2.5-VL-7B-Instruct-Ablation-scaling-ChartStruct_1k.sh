...
python -m verl.trainer.main_ppo \
    ...
    data.train_files=/data/MY_USERNAME/dmc61-workspace/veRL-MLLM-GRPO/data-rl-parquet/chart2code_mllm-20260112_102842/chart2code_combo_ChartStruct_1k_train.parquet \
    data.val_files=/data/MY_USERNAME/dmc61-workspace/veRL-MLLM-GRPO/data-rl-parquet/chart2code_mllm-20260112_102842/chart2code_combo_ChartStruct_1k_train.parquet \
    ...
    trainer.nnodes=1 \
    trainer.default_local_dir=targets/chart2code_mllm_qwen2.5_vl_7b_instruct_ablation_scaling_ChartStruct_1k_select_charts \
...
#
# 1. 快速后台启动
#    pyclean . && nohup bash chart2code-mllm-grpo-Qwen2.5-VL-7B-Instruct-Ablation-scaling-ChartStruct_1k.sh > /dev/null 2>&1 & 
# 
# 2. 一键后台 kill (发送 SIGTERM)
#    kill   $(ps aux | grep chart2code_mllm_qwen2.5_vl_7b_instruct_ablation_scaling_ChartStruct_1k_select_charts | grep -Ev 'grep --color=auto' | awk '{print $2}' | tr '\n' ' ')
#
...
# ---- 消融实验构造 ChartStruct 2k 训练集 chart_type 分布比例
# radar ---> 32
# bar ---> 145
# line ---> 124
# pie ---> 35
...
# contour ---> 32
# graph ---> 16
# Selected training dataset: 1002
# ---

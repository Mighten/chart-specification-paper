...
def build_apache_parquet_for_mllm_grpo():
    ...
    train_parquet_filepath = Path(os.path.join(local_dir, f'{"" if args.enable_thinking else "no_think_"}chart2code_combo_3k_train.parquet')).resolve().absolute().as_posix()
